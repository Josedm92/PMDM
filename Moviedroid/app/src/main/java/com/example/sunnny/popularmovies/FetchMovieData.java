...
class FetchMovieData extends AsyncTask<String,Void,Void> {
    ...
    protected Void doInBackground(String... params) {
        ...
        try {
            ...
            String MOVIE_DATA_BASE_URL ="http://api.themoviedb.org/3/movie/popular?api_key=c527fbe8fd1b4b7bdde1a357c824327a&language=es";


            if(params[0].equals("Top_Rated"))
            {
                MOVIE_DATA_BASE_URL ="http://api.themoviedb.org/3/movie/top_rated?api_key=c527fbe8fd1b4b7bdde1a357c824327a&language=es";
            }

            final String KEY="c527fbe8fd1b4b7bdde1a357c824327a&language=es";
